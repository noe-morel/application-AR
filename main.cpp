...
// OpenGL/GLUT
#include <Windows.h>
#include <C:/Dev/GLFW/include/glfw3.h>
...
void initGL(int argc, char * argv[]) {
   ...
   // We make sure the webcam frame's size to match that of the OpenGL's window
   arucoManager->resize(widthFrame, heightFrame);
   glfwSetWindowSize(window, widthFrame, heightFrame);

   //We load obj
   arucoManager->cle.Load("cle.obj"); //144 : clée
   arucoManager->coffre.Load("coffre.obj"); //143 : coffre
   arucoManager->coffre_open.Load("coffre_open.obj"); //143 : coffre open
   arucoManager->ile.Load("ile.obj"); //217 : ile
   arucoManager->mer.Load("mer.obj"); //217 : mer
